...
function requestData(provider, args, thisObj, timeout) {
    ...
    if (typeof provider === "function") {
        ...
        if (value !== undefined) {
            asyncValue.bA_(value);
        }
    } else {
        // Assume the provider is a data object...
        asyncValue.bA_(provider);
    }
    ...
    if (timeout > 0) {
        let timeoutId = setTimeout(function () {
            ...
            asyncValue.bz_(error);
        }, timeout);

        asyncValue.by_(function () {
            if (timeoutId != null) {
...
module.exports = function awaitTag(input, out) {
    ...
    if (clientReorder) {
        ...
        clientReorderContext = out.global.bB_ || (out.global.bB_ = {
            instances: [],
            nextId: 0
        });
