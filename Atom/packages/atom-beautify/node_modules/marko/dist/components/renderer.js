...
function handleBeginAsync(event) {
    ...
    asyncOut.c(parentOut._Y_, parentOut.a__, parentOut._Z_);
}
...
function createRendererFunc(templateRenderFunc, componentProps, renderingLogic) {
    ...
    return function renderer(input, out) {
        ...
        var componentDefFromArgs = out._Y_;
...
createRendererFunc._V_ = resolveComponentKey;
createRendererFunc._W_ = handleBeginAsync;