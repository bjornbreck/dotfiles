...
VElement.prototype = {
    ...
    e: function (tagName, attrs, key, component, childCount, flags, props) {
        var child = this.aX_(new VElement(tagName, attrs, key, component, childCount, flags, props));
    ...
    ed: function (tagName, attrs, key, component, childCount, flags, props) {
        var child = this.aX_(VElement.aZ_(tagName, attrs, key, component, childCount, flags, props));
    ...
    ap_: function (doc) {
        var namespaceURI = this.bm_;
        var tagName = this.ao_;
...
VElement.aZ_ = function (tagName, attrs, key, component, childCount, flags, props) {
    ...
    element.bm_ = namespace;
    return element;
};

VElement.bq_ = function (attrs) {
...
VElement.am_ = virtualizeElement;

VElement.an_ = function (fromEl, vFromEl, toEl) {
    var removePreservedAttributes = VElement.bq_;
